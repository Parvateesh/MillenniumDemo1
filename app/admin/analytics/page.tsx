...
async function getClickStats() {
  try {
    ...
    return { total: 0, thisWeek: 0, thisMonth: 0, recent: [], error: 'Could not load analytics. Firebase may still be initializing.' };
  }
}

export default async function AnalyticsPage() {
  const { total, thisWeek, thisMonth, recent, error } = await getClickStats();
