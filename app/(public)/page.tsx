      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-deal-badge">
            ...
            <span>$2.99 per game · $2.99 shoes every Tuesday &amp; Sunday — all day, walk-ins welcome</span>
        ...
        <div className="container">
          ...
          <div className="pricing-grid">
            <div className="price-card featured" data-animate="">
              ...
              <ul className="price-features"><li>All skill levels welcome</li><li>Shoe rental: $2.99</li><li>No reservation needed</li><li>Walk-in priority</li></ul>
            </div>
<div className="price-card" data-animate="">
          ...
          <div className="pricing-perks" data-animate="">
            ...
            <div className="pricing-perk"><span>👟</span> Shoe rental $2.99 Tue &amp; Sun · $4.50 other days</div>
          </div>
        </div>
      </section>
